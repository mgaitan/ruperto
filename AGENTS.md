...
Repository: https://github.com/mgaitan/ruperto

Description: A minimalist configurable agent
...
- Documentation previews for PRs with docs changes are published under `https://mgaitan.github.io/ruperto/_preview/pr-<PR_NUMBER>/`.
- Release/manual docs publish uses the canonical site URL: `https://mgaitan.github.io/ruperto/`.
